//
// Created by Patrick Hennis on 7/2/18.
//

#ifndef ZEN_ASYNCRPCOPERATION_CREATERAW_H
#define ZEN_ASYNCRPCOPERATION_CREATERAW_H
...
class AsyncRPCOperation_createraw : public AsyncRPCOperation {
public:
    AsyncRPCOperation_createraw(std::string fromAddress, std::vector<SendManyRecipient> tOutputs, std::vector<SendManyRecipient> zOutputs, int minDepth, CAmount fee = ASYNC_RPC_OPERATION_DEFAULT_MINERS_FEE, UniValue contextInfo = NullUniValue);
    virtual ~AsyncRPCOperation_createraw();

    // We don't want to be copied or moved around
    AsyncRPCOperation_createraw(AsyncRPCOperation_createraw const&) = delete;             // Copy construct
    AsyncRPCOperation_createraw(AsyncRPCOperation_createraw&&) = delete;                  // Move construct
    AsyncRPCOperation_createraw& operator=(AsyncRPCOperation_createraw const&) = delete;  // Copy assign
    AsyncRPCOperation_createraw& operator=(AsyncRPCOperation_createraw &&) = delete;      // Move assign
...
private:
    friend class TEST_FRIEND_AsyncRPCOperation_createraw;    // class for unit testing
...
class TEST_FRIEND_AsyncRPCOperation_createraw {
public:
    std::shared_ptr<AsyncRPCOperation_createraw> delegate;

    TEST_FRIEND_AsyncRPCOperation_createraw(std::shared_ptr<AsyncRPCOperation_createraw> ptr) : delegate(ptr) {}
...
#endif //ZEN_ASYNCRPCOPERATION_CREATERAW_H
